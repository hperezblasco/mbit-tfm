...
\hypersetup{colorlinks=false} % No links in printed version
}
...
This study uses simulated aircraft sensor values to predict when an aircraft engine will fail in the future so that maintenance can be planned in advance.
...
\textbf{MAE} & \textbf{M}ean \textbf{A}bsolut \textbf{E}rror\\
